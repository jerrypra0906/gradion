...
<p class="text-gray-600 mb-8">
  Have questions about LangkahKecil, need help with your account, or want to share
...
<div class="space-y-6">
  <div>
    ...
    <p class="text-gray-600">
      Send us an email at
      <a href="mailto:support@langkahkecil.com" class="text-blue-600 hover:text-blue-500 font-medium">
        support@langkahkecil.com
      </a>
  ...
  for (const content of contents) {
    try {
      ...
      if (existing) {
        ...
        console.log(`✓ Updated CMS content: ${content.slug}`);
      } else {
        // Create new content
        await prisma.cMSContent.create({
          data: content,
        });
        console.log(`✓ Created CMS content: ${content.slug}`);
      }
    } catch (error) {
